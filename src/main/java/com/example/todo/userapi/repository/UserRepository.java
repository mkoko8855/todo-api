...
public interface UserRepository extends JpaRepository<User, String> {
    ...
    //즉, 이메일로 회원 정보를 조회하자.
    Optional<User> findByEmail(String email); //리턴타입은 유저객체로 받아도 되는데, 옵셔널로받자. 그럼 널체크도 쉽겠지.
    ...
    boolean existsByEmail(String email); //exists는 String email이 존재하면 트루, 아니면폴스를 확인시켜주는 메서드이다.
